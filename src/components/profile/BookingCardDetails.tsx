...
const BookingCardDetails = ({ data }: Props) => {
  ...
  data.venue.meta.wifi && facilities.push(<FaWifi key={'wifi'} />);
  data.venue.meta.parking &&
    facilities.push(<FaSquareParking key={'parking'} />);
  data.venue.meta.breakfast &&
    facilities.push(<FaUtensils key={'breakfast'} />);
  data.venue.meta.pets && facilities.push(<FaDog key={'pets'} />);
