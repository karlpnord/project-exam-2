    ...
    <AnimatePresence>
      {!isExiting && (
        <motion.div
          ...
          className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center cursor-pointer font-inter"
          onClick={handleClose}
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-error to-red-800 p-8 rounded-md max-w-[440px] cursor-default"
          >
